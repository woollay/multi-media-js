export default class TimestampUtil {
     ...
     * @param {boolean} includeTime true表示输出的格式里一定会包含“时间:分钟”
     ...
     * @since 1.1
     */
    static shortFormat(timestamp, includeTime) {
        // 当前时间
        ...
        // 要额外显示的时间分钟
        let timeExtraStr = (includeTime ? " " + TimestampUtil.format(srcDate, "hh:mm") : "");
        ...
        if (currentYear == srcYear) {
            ...
            if (currentMonth == srcMonth && currentDateD == srcDateD) {
                ...
                // 否则当天其它时间段的，直接显示“时:分”的形式
                    ...
                    ret = TimestampUtil.format(srcDate, "hh:mm");
                }
            }
            // 当年 && 当天之外的时间（即昨天及以前的时间）
                ...
                // “前天”判断逻辑同上
                    ...
                    // 否则直接显示完整日期时间
                        ...
                        ret = TimestampUtil.format(srcDate, "yyyy/M/d") + timeExtraStr;
                    }
                }
            }
        }
